 ...
 * @var string
 */
	public static $sessionKey = 'AdminAuth.User';
	...
	protected function _unauthenticated(Controller $controller) {
		...
		if ($this->_isLoginAction($controller)) {
			if (empty($controller->request->data)) {
				if (!$this->Session->check('AdminAuth.redirect') && env('HTTP_REFERER')) {
					$this->Session->write('AdminAuth.redirect', $controller->referer(null, true));
				}
			}
			return true;
		}
		...
		if (!$controller->request->is('ajax')) {
			...
			$this->Session->write('AdminAuth.redirect', $controller->request->here(false));
 ...
 */
	public function logout() {
		...
		$this->Session->delete('AdminAuth.redirect');
		$this->Session->renew();
 ...
 */
	public function redirectUrl($url = null) {
		if ($url !== null) {
			$redir = $url;
			$this->Session->write('AdminAuth.redirect', $redir);
		} elseif ($this->Session->check('AdminAuth.redirect')) {
			$redir = $this->Session->read('AdminAuth.redirect');
			$this->Session->delete('AdminAuth.redirect');
