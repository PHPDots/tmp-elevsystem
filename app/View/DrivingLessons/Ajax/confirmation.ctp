<script type="text/javascript">    
    jQuery('#bookingAdd').dialog({
        ...
        buttons         : {
            'Yes'       : function(){
                jQuery.ajax({
                    url         : '<?PHP echo $this->Html->url(array('controller' => 'bookings','action'=>'updateStudentDetails',$id)); ?>',
                    type        : 'post',
                    dataType    : 'json',
...
<div id="bookingAdd" style="display: none;" title="<?php echo $title; ?>">
    <p><?php echo __("If {$student} has delivered first-aid training + medical report."); ?></p>
</div>
