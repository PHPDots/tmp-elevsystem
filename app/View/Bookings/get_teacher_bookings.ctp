<div class="inner-content"><div class="row-fluid"><div class="span12">      
    <div class="widget">
        <div class="widget-header">
            <h5><?php echo __('Lærens bookinger'); ?></h5>  
            <div style="display: <?php echo ($role == 'admin') ? 'block' : 'none' ?>">
                <?php 
                echo $this->Html->link(__('Kalendervisning for lærer'),array(
                    'controller'    => 'Bookings',
                    'action'        => 'TeacherListBookings'
                ));
                ?>
            </div>
        </div>
