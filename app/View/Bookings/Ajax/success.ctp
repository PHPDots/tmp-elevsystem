    ...
    jQuery('#bookingAdd').dialog({
        ...
        buttons         : {
            'Ok'        : function(){
                ...
                window.location.href = "<?php echo $this->Html->url(array('controller' => 'bookings','action'=>'calendar')); ?>"+url;
//                window.location.href = "<?php // echo $this->Html->url(array('controller' => 'bookings','action'=>'redirectUrl')); ?>"+url;
            }
        }
    });       
</script>
