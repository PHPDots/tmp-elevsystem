<div class="inner-content"><div class="row-fluid"><div class="span12">      
    <div class="widget">
        <div class="widget-header">
            <h5><?php echo __('Cities'); ?></h5>  
            <?php 
            echo $this->Html->link(__('Add City'),array(
                'controller'    => 'cities',
                'action'        => 'add'
            ));
            ?>
        ...
        <div class="tableLicense">
            <table cellpading="0" cellspacing="0" border="0" class="default-table">
                <tr>
                    ...
                    <th align="left"><?php echo __('City Code');?></th>
                    <th align="left"><?php echo __('FIK/Girokort code');?></th>
                ...
                ?>
                    <tr>
                        <td colspan="5" class="index_msg"><?php  echo __('No Cities are added'); ?></td>
                    </tr>
                <?php                   
                }
                ?>
