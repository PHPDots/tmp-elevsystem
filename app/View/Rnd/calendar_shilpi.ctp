...
//        element.parent().find('.timeSlotSelectCt').html(html);//.chosen();
//        
//        element.parent().find('.timeSlotSelectCt').chosen().trigger("chosen:updated");
//        element.parent().find('.timeSlotSelectCt').parent().find('.chosen-container-multi').attr('style','width:100%');
    ...
    jQuery(document).ready(function(){
        ...
        jQuery(document).delegate('.trackCheckbox','click',function() {
            ...
            //jQuery('#tracksSelection').find('.timeSlotSelectCt').chosen().trigger("chosen:updated");
            //jQuery('#tracksSelection').find('.timeSlotSelectCt').parent().find('.chosen-container-multi').attr('style','width:100%');
